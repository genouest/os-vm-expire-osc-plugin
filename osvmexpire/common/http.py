...
from osvmexpire.common import utils
from osvmexpire import exc

LOG = logging.getLogger(__name__)
USER_AGENT = 'python-osvmexpireclient'
...
def authenticated_fetcher(hc):
    """A wrapper around the osvmexpire client object to fetch a template."""
...
def _construct_http_client(endpoint=None, username=None, password=None,
    ...
    if session:
        ...
        if 'service_type' not in kwargs:
            kwargs['service_type'] = 'openstackvmexpirationmanagement'
